...
nulb    = uLB*ny/Re;             # Viscoscity in lattice units. velocity*rayon/Raynolds
...
if systemCheck :
    ...
    plt.plot(arange(0,ny,1), uformula,label="Theoretical profile Tube",)
