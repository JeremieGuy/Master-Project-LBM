...
if savefiles : 
    new_dir_monitoring = "./Monitoring/Monitoring_tube_no_roll_flags_obstacle_" + str(maxIter) + "_it"
...
if velocityEvolution:
    new_dir_velocity = "./Velocity_Profile/VelocityProfile_flags_obstacle_" + str(maxIter) + "_it"
...
if saveVisual :
    new_dir_visual = "./Flow/Flow_no_roll_flags_obstacle_" + str(maxIter) + "_it"
